                ...
                <div class="col-md-12">
                    <form class="" id="addpiece" action="{{ url('documents/add') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="ref_types_documents_id" name="ref_types_documents_id" class="form-control selectpicker bordered"  title="{{ trans('text_my.selectionner') }}" data-live-search="true">
                                @foreach($types_docum as $type_docum)
                                    <option value="{{$type_docum->id}}" >{{$type_docum->$lib}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
