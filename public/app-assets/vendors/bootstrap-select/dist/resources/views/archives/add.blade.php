        ...
        <div class="col-md-12" id="addForm">
            <form class="" action="{{ url('archives/add') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="secteur_id">{{ trans('text_archive.categorie_archive') }} <span
                                class="required_field" data-toggle="tooltip" data-placement="right"
                                title="{{ trans('text.champ_obligatoire') }}">*</span></label>
                        <select id="ref_type_archive" name="ref_type_archive_id" onchange="changeType()"
                                class="form-control selectpicker bordered"
                                title="{{ trans('text_archive.selectionner') }}" data-live-search="true">
                    ...
                    <div class="form-group col-md-12">
                        <label for="fichier">{{ trans('text_archive.fichier') }} <span class="required_field"
                                                                                       data-toggle="tooltip"
                    ...
                    <div class="row col-lg-12 emplm" style="display:none">
                        <div class="col-md-6 form-group">
                            <label for="secteur_id">{{ trans('text_archive.emplacement') }} <span class="required_field"
                                                                                                  data-toggle="tooltip"
                                                                                                  data-placement="right"
                                                                                                  title="{{ trans('text.champ_obligatoire') }}">*</span></label>
                            <select id="ar_emplacement_id" name="ar_emplacement_id"
                                    class="form-control selectpicker bordered"
                                    title="{{ trans('text_archive.selectionner') }}" data-live-search="true">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="secteur_id">{{ trans('text_archive.qualite') }} <span class="required_field"
                                                                                              data-toggle="tooltip"
                                                                                              data-placement="right"
                                                                                              title="{{ trans('text.champ_obligatoire') }}">*</span></label>
                            <select id="ar_qualite_id" name="ar_qualite_id" class="form-control selectpicker bordered"
                                    title="{{ trans('text_archive.selectionner') }}" data-live-search="true">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="secteur_id">{{ trans('text_archive.service') }} <span class="required_field"
                                                                                          data-toggle="tooltip"
                                                                                          data-placement="right"
                                                                                          title="{{ trans('text.champ_obligatoire') }}">*</span></label>
                        <select id="service_id" name="service_id" class="form-control selectpicker bordered"
                                title="{{ trans('text_archive.selectionner') }}" data-live-search="true">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="libelle_ar">{{ trans('text_archive.date_archivage') }} <span class="required_field"
                                                                                                 data-toggle="tooltip"
                                                                                                 data-placement="right"
                                                                                                 title="{{ trans('text.champ_obligatoire') }}">*</span>
                        </label>
                        <input type="date" value="{{date('Y-m-d')}}" id="date_archivage" name="date_archivage"
                               class="form-control">

                    </div>
                    <div class="col-md-12 form-group valeurs">
                        <label for="valeurs">{{ trans('text_archive.mots_cles') }}
                            ({{ trans('text_archive.separer_par_points') }})</label>
