                ...
                <fieldset @if(!Auth::user()->hasAccess([7],2)) disabled="disabled" @endif >
                    <div class="form-row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select id="ref_type_archive_id" disabled name="ref_type_archive_id" class="form-control selectpicker bordered"  title="{{ trans('text_archive.selectionner') }}" data-live-search="true"> 
                        ...
                        <div class="form-group col-md-12 valeurs" >
                            <label for="valeurs">{{ trans('text_archive.mots_cles') }} ({{ trans('text_archive.separer_par_points') }})</label>
