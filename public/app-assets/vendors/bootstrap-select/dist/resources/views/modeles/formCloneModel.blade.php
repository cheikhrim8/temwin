<div class="modal-header">
    <h5 class="modal-title">{{ trans('text.new_copy_model') }} <a style="color: #1F90E2!important;"> {{ $libelle }}</a></h5>
...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12" id="addFormCopy">
            <form class="" action="{{ url('modeles/cloneModel') }}" method="post">
                {{ csrf_field() }}
                <div class="form-row">
                    ...
                    <div class="col-md-6 form-group">
                     ...
                     <input type="hidden" value="{{ $ref_model }}" name="ref_model" />
                    <div class="col-md-12 form-row">
                        ...
                        <div class="col-md-4 form-group text-right">
                            <button class="btn btn-success btn-icon-split" onclick="addObject(this,'modeles')" container="addFormCopy">
