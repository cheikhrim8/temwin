        ...
        <form class="" action="{{ url('modeles/saveElement') }}" method="post">
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="content_value">{{ trans('text_me.content_value_fr') }}<span class="required_field" data-toggle="tooltip" data-placement="right" title="{{ trans('text.champ_obligatoire') }}">*</span></label>
                ...
                <div class="col-md-4 form-group" id="type_ligne" style="display: none;">
                    <label for="type_ligne">{{ trans('text_me.type') }}</label>
                    <select  name="type_ligne" class="form-control" >
                ...
                <div class="col-md-4 form-group" id="style_element">
                    <label for="style">{{ trans('text_me.style_element') }}</label>
                    <input type="checkbox" name="stle" id="style"/>
                </div>
